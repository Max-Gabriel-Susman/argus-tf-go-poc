...
// func NewDetection(tf tensorflow.MachineLearningInterface, openCV opencv.ImageProcessorInterface) *Detection {
...
// func (rduc *Detection) Execute(frame gocv.Mat) {
func (rduc *Detection) Execute() {
